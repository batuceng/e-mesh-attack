...
for epoch in range(MAX_EPOCH):
    ...
    # Verbose    
    print(f"""------Model:{args.model} EPOCH:{epoch}, lr:{optimizer.param_groups[0]['lr']}-------
        Train Loss:{train_epoch_loss_list[epoch]}, Train Acc:{train_acc_list[epoch]}
        Test Loss:{test_epoch_loss_list[epoch]}, Test Acc:{test_acc_list[epoch]}""")
    # Log Tensorboard
